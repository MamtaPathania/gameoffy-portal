...
//         <div className='lg:p-6'>
//             <h1 className="font-sans text-3xl text-white">Search</h1>
//            <input type="text" placeholder="Search here....." value={search} onChange={handleChange} className="h-[30px] w-1/2 px-4"></input>
//            <button className="bg-pink-700 text-white px-4 py-1 mx-4">Search </button>
//         </div>text
//         </div>
//     )
// }
